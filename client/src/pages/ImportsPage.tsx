...
export default function ImportsPage() {
  ...
  return (
    <div className="page">
      <div className="page-header"><div className="title"><h1>Imports / exports</h1><p>Importez un plan de production (format legacy « SOP - PDP » ou format long), exportez la simulation dans un classeur Excel et réimportez les saisies faites dans l'onglet SAISIES.</p></div></div>
      ...
      <div className="grid cols-2">
        ...
        <Card title="Exporter la simulation" hint="Classeur complet : PARAMETRES, SIMULATION, ALERTES, PROPOSITIONS, CARNET_COMMANDES, SAISIES">
          <div className="form-grid">
          ...
          <h4>Réimporter des saisies (onglet SAISIES)</h4>
